...
var defaults = {
  ...
  */
  codegen: {
     ...
     * endpoint
    */
    servers: 'https://generator.swagger.io/online/api/gen/servers',
    clients: 'https://generator.swagger.io/online/api/gen/clients',

    /*
     * For each item in menu item, Swagger Editor will make calls to these
     * endpoint to download the generated code accordingly
    */
    server: 'https://generator.swagger.io/online/api/gen/servers/{language}',
    client: 'https://generator.swagger.io/online/api/gen/clients/{language}'
  },
